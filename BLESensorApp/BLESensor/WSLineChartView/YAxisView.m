...
- (id)initWithFrame:(CGRect)frame yMax:(CGFloat)yMax yMin:(CGFloat)yMin unity:(NSString *)unity{
...
- (void)drawRect:(CGRect)rect {
    ...
    CGSize waterLabelSize = [self.unity sizeWithAttributes:waterAttr];
    CGRect waterRect = CGRectMake(self.frame.size.width - 1-5 - waterLabelSize.width, 0,waterLabelSize.width,waterLabelSize.height);
    [self.unity drawInRect:waterRect withAttributes:@{NSFontAttributeName :[UIFont systemFontOfSize:8],NSForegroundColorAttributeName:kChartTextColor}];
